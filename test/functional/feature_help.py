...
"""Verify that starting xczm with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start xczm with -? for help text")
        ...
        self.log.info("Start xczm with -version for version information")
