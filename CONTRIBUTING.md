Contributing to xczm Core
============================

The xczm Core project operates an open contributor model where anyone is
...
The following applies to code changes to the xczm Core project, and is not to be
confused with overall xczm Network Protocol consensus changes.

Whether a pull request is merged into xczm Core rests with the project merge
...
Patches that change xczm consensus rules are considerably more involved than
...
Where a patchset proposes to change the xczm consensus, it must have been
...
The project leader is the release manager for each xczm Core release.
