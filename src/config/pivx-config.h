...
#define PACKAGE_BUGREPORT "https://github.com/Masternodesguru/XCZM"

/* Define to the full name of this package. */
#define PACKAGE_NAME "xczm Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "xczm Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "xczm"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://masternodes.guru/"
