...
/* xczm GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "xczm"
#define QAPP_ORG_DOMAIN "xczm.org"
#define QAPP_APP_NAME_DEFAULT "xczm-Qt"
#define QAPP_APP_NAME_TESTNET "xczm-Qt-testnet"
