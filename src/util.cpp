...
const char * const PIVX_CONF_FILENAME = "xczm.conf";
const char * const PIVX_PID_FILENAME = "xczm.pid";
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\xczm
// Windows >= Vista: C:\Users\Username\AppData\Roaming\xczm
// Mac: ~/Library/Application Support/xczm
// Unix: ~/.xczm
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "xczm";
#else
    fs::path pathRet;
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty xczm.conf if it does not exist
        ...
        if (configFile != NULL) {
	        ...
	        strHeader += "\nrpcport=35560\naddnode=seed1.masternodes.guru:35561\naddnode=seed2.masternodes.guru:35561\naddnode=seed3.masternodes.guru:35561\naddnode=seed4.masternodes.guru:35561\naddnode=seed5.masternodes.guru:35561\naddnode=seed6.masternodes.guru:35561\naddnode=seed7.masternodes.guru:35561\naddnode=seed8.masternodes.guru:35561\n";
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override xczm.conf
