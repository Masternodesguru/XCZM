...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* xczm features */
        {"xczm", "listmasternodes", &listmasternodes, true },
        {"xczm", "getmasternodecount", &getmasternodecount, true },
        {"xczm", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"xczm", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"xczm", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"xczm", "masternodecurrent", &masternodecurrent, true },
        {"xczm", "startmasternode", &startmasternode, true },
        {"xczm", "createmasternodekey", &createmasternodekey, true },
        {"xczm", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"xczm", "listmasternodeconf", &listmasternodeconf, true },
        {"xczm", "getmasternodestatus", &getmasternodestatus, true },
        {"xczm", "getmasternodewinners", &getmasternodewinners, true },
        {"xczm", "getmasternodescores", &getmasternodescores, true },
        {"xczm", "mnsync", &mnsync, true },
        {"xczm", "spork", &spork, true },
...
{
    return "> xczm-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:35560/\n";
}
