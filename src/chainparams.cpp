...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000002f13c908a26c41fbfa98ba8f2108db0ba84a076429387d2f318217b1a70"))

;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1702753196, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1702753196, 15646799, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();



        assert(consensus.hashGenesisBlock == uint256S("0x000002f13c908a26c41fbfa98ba8f2108db0ba84a076429387d2f318217b1a70"));
        assert(genesis.hashMerkleRoot == uint256S("0xf6131233bbe6b5ac3421769d064cabba7f535d155d3a666a84bd167533b954b1"));
        ...
        consensus.mBurnAddresses = {
           { "xczmBuRnxczmxxxxxxxxxxxxTpDJ6", 0 }
        };
    	...
    	vSeeds.push_back(CDNSSeedData("seed1",  "seed1.masternodes.guru"));
        vSeeds.push_back(CDNSSeedData("seed2",  "seed2.masternodes.guru"));
        vSeeds.push_back(CDNSSeedData("seed3",  "seed3.masternodes.guru"));
...
public:
    CTestNetParams()
    {
        ...
        genesis = CreateGenesisBlock(1702753196, 2402015, 0x1e0ffff0, 1, 250 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        //assert(consensus.hashGenesisBlock == uint256S("0x0000041e482b9b9691d98eefb48473405c0b8ec31b76df3797c74a78680ef818"));
        //assert(genesis.hashMerkleRoot == uint256S("0x1b2ef6e2f28be914103a277377ae7729dcd125dfeb8bf97bd5964ba72b6dc39b"));

        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // xczm starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        vSeeds.push_back(CDNSSeedData("tseeder", "tseeder.__masternodes.guru__", true));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet xczm addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet xczm script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet xczm BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet xczm BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet xczm BIP44 coin type is '1' (All coin's testnet default)
