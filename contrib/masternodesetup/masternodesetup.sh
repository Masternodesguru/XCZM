...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='xczm.conf'
CONFIGFOLDER='/root/.xczm'
COIN_DAEMON='xczmd'
COIN_CLI='xczm-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/xczm/xczm/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
