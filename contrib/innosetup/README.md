...
* Fill in the following data:
    * Application Name: `xczm Core`
    * Application Version: `2.0.0.0`
    * Application Publisher: `2021-2022 The xczm Developers`
    * Application Website: `https://masternodes.guru/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `xczm`
* Add application files:
    * Select the file `xczm-qt.exe` as main executable from the `package` folder
...
* Compiler settings
    ...
    * Edit the output base filename to: `xczm-2.0.0-win64-setup.exe`
