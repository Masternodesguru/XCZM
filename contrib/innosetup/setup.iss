...
#define MyAppName "xczm Core"
#define MyAppPublisher "2021-2022 The xczm Developers"
#define MyAppURL "https://github.com/Masternodesguru/XCZM"
#define MyAppExeName "xczm-qt.exe"
#define MyAppExtraData "https://github.com/Masternodesguru/XCZM/releases/download/v2.0/bootstrap.zip"
...
[Files]
Source: ".\package\xczm-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\xczm\xczm-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\xczm\xczm-Qt,strDataDir|{userappdata}\xczm\}');
  Result := True;
end;
